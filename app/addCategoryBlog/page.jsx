"use client";
import { addCategoryBlog } from "@/lib/api";
    ...
    <>
      <div className="mx-auto w-[1250px] pt-36">
        <label htmlFor="input" className="block mb-2">
          Add Category Blog<span className="text-red-600 text-xl"> *</span>
        </label>
        <form onSubmit={onsubmit}>
          <input
            ...
            placeholder="Enter Category Blog EN"
          />
          <input
            type="text"
            name="input"
            ...
            placeholder="Enter Category Blog CZ"
          />
          <input
            type="text"
            name="input"
            required
            className=" outline-none cat rounded-md px-5 h-12 text-black/60 w-10/12"
            placeholder="Enter Category Blog AR"
          />
          <button
            type="submit"
