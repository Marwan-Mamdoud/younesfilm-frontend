  ...
  return (
    <>
      <div
        ...
        className={`${
          openDialop ? "" : "hidden"
        } top-0 right-0 w-[100dvw] z-30 fixed flex items-center justify-center h-[100dvh] backdrop-blur-md  text-black`}
      >
      ...
      <div
        className={`${
          openDialop ? "-z-10" : ""
        }w-[330px] h-[350px] relative cursor-move rounded-lg my-10 block`}
      >
        <Link href={`/${id}`} className="">
          ...
          />
          <p className="font-bold text-2xl absolute bottom-0 py-5 px-4">
            {name}
          </p>
